...
<h2>Description</h2>
In this lab we will create a ticketing system environment on a local webserver that is running on a Virtual Machine in a cloud platform. For this project we will be utilizing OsTicket as our ticketing software and Microsoft's Azure, Windows 10 Pro and Internet Information Services as our environment to set up our ticketing system. This lab will resemble any ticketing system utilized for the technical support operations of an IT department and can serve as an environment to explore and learn the parameters of working a ticket for an IT Help Desk Technician.
